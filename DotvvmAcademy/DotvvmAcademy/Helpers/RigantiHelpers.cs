...
namespace DotvvmAcademy.Helpers
{
    public static class RigantiHelpers
    {
        ...
        ///     Convers the string to DateTime or returns null if the string is not valid.
        /// </summary>
        public static DateTime? ToNullableDateTime(this string value, string format, IFormatProvider formatProvider,
        ...
        ///     Convers the string to DateTime or returns null if the string is not valid.
        /// </summary>
        public static DateTime? ToNullableDateTime(this string value, string[] formats, IFormatProvider formatProvider,
            DateTimeStyles styles = DateTimeStyles.None)
        {
            DateTime number;
            return DateTime.TryParseExact(value, formats, formatProvider, styles, out number)
                ? number
                : (DateTime?) null;
        }
    }

...
{
    public class ReflectionNameConverter : IMetaConverter<MemberInfo, NameNode>
    {
        public IEnumerable<NameNode> Convert(MemberInfo source)
        {
            return ImmutableArray.Create(Visit(source));
        }
